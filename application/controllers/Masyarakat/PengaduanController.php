...
class PengaduanController extends CI_Controller {
			...
			if ($upload_foto == FALSE) :
				...
				if ($resp) :
					$this->session->set_flashdata('msg','<div class="alert alert-success" role="alert">
						Laporan pengaduan berhasil dibuat
						</div>');

					redirect('Masyarakat/PengaduanController/laporan_ku');
				else :
					$this->session->set_flashdata('msg','<div class="alert alert-danger" role="alert">
	...
	public function pengaduan_detail($id)
	{
		...
		if ( ! empty($cek_data)) :
			...
			redirect('Masyarakat/PengaduanController?latihan_ku');			
		endif;
	}
