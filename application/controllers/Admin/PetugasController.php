...
class PetugasController extends CI_Controller {
	...
	public function index()
	{
		...
		$this->form_validation->set_rules('password','Password','trim|required|alpha_numeric_spaces|min_length[4]|max_length[15]');
	...
	if ( ! empty($cek_data)) :
		...
		if ($resp) :
			...
			redirect('Admin/PetugasController/data_user');
		else :
			$this->session->set_flashdata('msg','<div class="alert alert-danger" role="alert">
				Akun gagal dihapus!
				</div>');
